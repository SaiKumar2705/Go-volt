...
public class MyExpandableListAdapterLatest extends BaseExpandableListAdapter {

    // Declare context object
    private Context mContext;
    private List<String> mParents;
    private Map<String, String> mChildrenMapLatest;

   
    public MyExpandableListAdapterLatest(Context context, List<String> parents, Map<String, String> childrenMap) {
        this.mContext = context;
        this.mParents = parents;
        this.mChildrenMapLatest = childrenMap;
    }
    ...
    public int getChildrenCount(int groupPosition) {
        return mChildrenMapLatest.size();
    }
    ...
    public Object getChild(int groupPosition, int childPosition) {
        return mChildrenMapLatest.get(groupPosition);
