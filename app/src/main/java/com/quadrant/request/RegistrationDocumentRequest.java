...
public class RegistrationDocumentRequest {
    ...
    private  String driving_expiry_date,driving_release_date, driving_lincense_holder_name,nationality,guy,driving_license_number,driving_license_nationality,driving_authorities,found_service_via;

  //  private  Long driving_expiry_date,driving_release_date;
    ...
    public String getFound_service_via() {
        return found_service_via;
    }

    public void setFound_service_via(String found_service_via) {
        this.found_service_via = found_service_via;
    }
   ...
   /* public Long getDriving_release_date() {
        return driving_release_date;
    }

    public void setDriving_release_date(Long driving_release_date) {
        this.driving_release_date = driving_release_date;
    }

    public Long getDriving_expiry_date() {
        return driving_expiry_date;
    }

    public void setDriving_expiry_date(Long driving_expiry_date) {
        this.driving_expiry_date = driving_expiry_date;
    }*/
}
