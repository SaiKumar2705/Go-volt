...
public class CameraSwitchView extends AppCompatImageButton {
    ...
    private void initializeView() {
        ...
        frontCameraDrawable = ContextCompat.getDrawable(context, R.drawable.ic_cameraflip);
        ...
        rearCameraDrawable = ContextCompat.getDrawable(context, R.drawable.ic_cameraflip);
